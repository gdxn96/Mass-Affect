...
function Animation(argImgSrc, dataUrl, canvasId, initialFps)
{
	...
	function fillFrameList(frames)
	{
		...
		var width = frames[0]["frame"]["w"];
		var height = frames[0]["frame"]["h"];

		console.log(canvasSize)
		var scaleX = canvasSize.w / width;
		var scaleY = canvasSize.h /  height;
		...
		for(var i = 0; i < frames.length; i++)
		{
			...
			destWidth = sWidth * scaleX;
			destHeight = sHeight * scaleY;
